...
Replace `<RELEASE_NAME>` with your custom release name for the {helm} chart deployment. Replace `<APP_VERSION>` with the desired application version (for example, `1.2`).
